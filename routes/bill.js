...
router.post('/generateReport', auth.authenticateToken, (req,res)=>{
    ...
    connection.query(query, [orderDetails.name, generateUuid, orderDetails.email, orderDetails.contactNumber, orderDetails.paymentMethod, orderDetails.totalAmount, orderDetails.productDetai, res.locals.email], (err, results)=>{
        if(!err){
